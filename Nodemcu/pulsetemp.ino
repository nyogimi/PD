...
void config_rest_server_routing() {
  ...
  http_rest_server.on("/oximeter", HTTP_GET, get_oximeter);
}
...
void get_oximeter() {
  Serial.println(F("HTTP GET for Oximeter Data"));
  StaticJsonDocument<128> jsonDoc;

  // You can replace these with actual values from your pulse oximeter sensor
  int heart_rate = 70; // Example heart rate
  int spo2 = 98; // Example SpO2 level
  
  jsonDoc["heart_rate"] = heart_rate;                                      
  jsonDoc["spo2"] = spo2;
